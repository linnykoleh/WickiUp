package com.pluralsight.persistence.module07.view;

import com.pluralsight.persistence.module07.model.Publisher;
import com.pluralsight.persistence.module07.util.Loggable;
...
public class PublisherBean implements Serializable {
  ...
  @PersistenceContext(unitName = "module07PU", type = PersistenceContextType.EXTENDED)
