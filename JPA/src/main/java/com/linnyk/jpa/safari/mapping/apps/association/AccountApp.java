...
public class AccountApp {
    ...
    public void testManyToManyUnidirectional() {
        ...
        final Account account = EntityUtil.getAccount("Account 1");
        final Account account1 = EntityUtil.getAccount("Account 2");

        final User user = EntityUtil.getUser("Oleh", "Linnyk");
        final User user1 = EntityUtil.getUser("Iryna", "Linnyk");
