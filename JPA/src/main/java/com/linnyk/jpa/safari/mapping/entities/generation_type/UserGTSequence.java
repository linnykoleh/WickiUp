package com.linnyk.jpa.safari.mapping.entities.generation_type;
...
public class UserGTSequence {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "user_sequence_generator")
    @SequenceGenerator(name = "user_sequence_generator", sequenceName = "USER_ID_SEQUENCE")
    // Нужно руками создать sequence
    // CREATE SEQUENCE USER_ID_SEQUENCE START WITH 1 INCREMENT BY 5;
    @Column(name = "USER_ID")
    private Long userId;
