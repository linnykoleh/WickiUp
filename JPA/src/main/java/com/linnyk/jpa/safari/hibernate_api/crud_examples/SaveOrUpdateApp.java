...
public class SaveOrUpdateApp {
	...
	public void testSaveOrUpdate() {
		...
		final Bank newBank = EntitiesUtil.getBank("The best bank");

		final Session session1 = HibernateFactoryBuilder.getSessionFactoryXML().openSession();
		final Transaction transaction1 = session1.beginTransaction();

		session1.saveOrUpdate(newBank);
		...
		session1.saveOrUpdate(bank);

		bank.setName("Test bank 2");
